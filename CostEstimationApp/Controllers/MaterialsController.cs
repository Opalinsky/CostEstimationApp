...
namespace CostEstimationApp.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PricePerKg,Density")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PricePerKg,Density")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
