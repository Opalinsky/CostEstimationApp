...
namespace CostEstimationApp.Migrations
{
    ...
    [Migration("20240526132822_OpertinType11")]
    partial class OpertinType11
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CostEstimationApp.Models.Tool", b =>
                {
                    b.HasOne("CostEstimationApp.Models.ToolMaterial", "ToolMaterials")
                        .WithMany("Tools")
                        .HasForeignKey("ToolMaterialId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ToolMaterials");
                });
